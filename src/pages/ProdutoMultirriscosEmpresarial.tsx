...
export default function ProdutoMultirriscosEmpresarial() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col items-center py-12 px-4">
      <Seo
        title="Seguro Multirriscos Empresarial"
        description="Proteja edifícios, equipamentos e mercadorias da sua empresa com coberturas flexíveis."
        canonicalPath="/produto-multirriscos-empresarial"
      />
