...
export default function ProdutoMultirriscosEmpresarial() {
  const { t } = useTranslation('product_mreb');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col items-center py-12 px-4">
      <Seo
        ...
        canonicalPath={`/${base}/produto-multirriscos-empresarial`}
      />
  ...
  <div className="relative h-56 md:h-80 w-full flex items-center justify-center bg-blue-900">
          <img src="https://images.pexels.com/photos/323705/pexels-photo-323705.jpeg?auto=compress&w=800&q=60" alt={t('headerTitle')} className="absolute inset-0 w-full h-full object-cover opacity-30" />
