...
export default function ProdutoSaude() {
  const { t } = useTranslation('product_health');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white flex flex-col items-center py-12 px-4">
      <Seo
        ...
        canonicalPath={`/${base}/produto-saude`}
      />
  ...
  <div className="relative h-56 md:h-80 w-full flex items-center justify-center bg-blue-900">
          <img src="https://images.pexels.com/photos/5452201/pexels-photo-5452201.jpeg?auto=compress&w=800&q=60" alt={t('headerTitle')} className="absolute inset-0 w-full h-full object-cover opacity-30" />
          <div className="relative z-10 text-center w-full">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
              <Link to={`/${base}/simulacao-saude`} className="inline-block px-8 py-3 bg-green-400 text-blue-900 font-bold rounded-full shadow-lg hover:bg-green-300 transition">{t('ctaSimulate')}</Link>
