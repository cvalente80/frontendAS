# Background images — attributions

These background photos were downloaded from Wikimedia Commons via the Wikipedia lead images API.

| Site | Output file | Source (Wikimedia Commons) | License | Author |
|---|---|---|---|---|
| Lisboa | `public/imagens/bg-lisboa.jpg` | https://commons.wikimedia.org/wiki/File%3ALisbon_(36831596786)_(cropped).jpg | CC BY 2.0 | Deensel |
